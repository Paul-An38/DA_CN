                                    ...
                                    <table class="table table-bordered" id=""  width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            if($noidung!='')
                                            {
                                                ...
                                                $tung_trang= ($trang-1)*$so_sp_1trang; // san pham bat dau
                                                $sqlsp="SELECT * from sanpham 
                                                         where sanpham.tensanpham like '%$noidung%' LIMIT $tung_trang,$so_sp_1trang ";// phan trang cho ket qua tim kiem
                                                $stmsp= $obj->query($sqlsp);    
                                            }
                                            else{
                                                $so_sp_1trang=5;
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="edit.php?masanpham=<?php echo $v['masanpham']?>">

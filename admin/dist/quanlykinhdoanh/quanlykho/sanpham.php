                                ...
                                <form action="chucnang.php?action=them" enctype="multipart/form-data" method="post" style="width:1300px">
                                    <div style="width:550px; float:left;height:300px">
                                        <table > 
                                            <tr>
                                                <td>Mã SP:</td>
                                                <td><input type="text" name="masanpham" value="SP<?php echo $soluongsp+1?>" placeholder="" id=""></td>
                                            </tr>
                                            <tr>
                                                <td>Loại:</td>
                                                <td >
                                            ...
                                            <tr>
                                                <td>Hình:</td>
                                                <td><input multiple="multiple" type="file" name="hinh" id=""></td>
                                            </tr>
                                            <tr>
                                                <td>Giá:</td>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                <table  class="table table-bordered" id=""  width="100%" cellspacing="0">
                                    ...
                                    <?php
                                        ...
                                        $sql="SELECT * FROM sanpham where  trangthai='0' LIMIT $tungtrang,$so_sp_1trang ";
                                        $stm=$obj->query($sql);
                                        $da=$stm->fetchALL();
                                        foreach($da as $k =>$v)
                                        {
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <a class="btn btn-mini" style="width:90px;background-color:green; color:white; float:right;" href="chucnang.php?action=kichhoat&masanpham=<?php echo $v['masanpham'] ?>">Start</a>
                                            <a class="btn btn-mini" style="width:90px;background-color:red; color:white; float:right;" href="chucnang.php?action=ngung&masanpham=<?php echo $v['masanpham'] ?>">Stop</a></td>
                                    </tbody>
                                    <?php
                                        }
                                        ?>
                            ...
                            <div class="card-body" style="margin-left:500px;">
                                <?php
                                    ...
                                    {
                                    ?>
                                    <a href="sanpham.php?trang=<?php echo$i?>"><?php echo $i?></a>
                                    <?php
                                    }
                                ?>
                            </div>

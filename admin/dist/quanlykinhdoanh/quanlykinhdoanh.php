                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="quanlykho/quanlykho.php" >
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Quản lý Kho
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            
                            <a class="nav-link collapsed" href="dieuphoi/dieuphoi.php" >
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Điều phối
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Quản Lý Kinh Doanh</h1>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="" style="text-align:center;" width="100%" cellspacing="0" >
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo"(".$quantri['quyen'].")"?>Quản lý Kinh doanh</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Quản lý kho</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quanlykho/quanlykho.php">Go to</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Điều phối</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dieuphoi/dieuphoi.php">Go to</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>

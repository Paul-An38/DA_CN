            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Điều phối viên</h1>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="" style="text-align:center;" width="100%" cellspacing="0" >
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo "(".$quantri['quyen'].")"?>Điều phối đơn hàng</td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quanlydonhang.php">Go to</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">Quản lý Đơn hàng giao</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quanlydonhanggiao.php">Go to</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>

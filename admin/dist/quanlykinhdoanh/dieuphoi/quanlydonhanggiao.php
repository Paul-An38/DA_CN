            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Điều phối Đơn hàng giao</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id=""  width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            if($noidung!='')
                                            {
                                                ...
                                                $sqldh="SELECT * from donhang where trangthai='Đang giao hàng' LIMIT $tung_trang,$so_dh_1trang ";
                                                $stmdh= $obj->query($sqldh);
                                            }
                                            $dh=$stmdh->fetchALL();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="chucnang.php?action=thanhcong&madonhang=<?php echo $v['madonhang']?>">
                                                        <div style="background-color:#007bff; color:white;" class="btn btn-mini">Thành công</div>
                                                    </a>
                                                    <a  href="chucnang.php?action=thatbai&madonhang=<?php echo $v['madonhang']?>">
                                                        <div style="color:white;background-color:#dc3545;"class="btn btn-mini">Thất bại</div>
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div style="margin-left:500px;">
                                        ...
                                        {
                                            ?>
                                            <a href="quanlydonhanggiao.php?trang=<?php echo $i?>"><?php echo $i?></a>
                                            <?php
                                        }
                                        ?>
                                    </div>

...
<html lang="en">
    <head>
        ...
        <title>Quản Lý đon hàng bị hủy</title>
    ...
    <?php
        ...
        $sql="SELECT * From donhang where trangthai LIKE '%Đơn hàng đã bị hủy%'";
        $stm=$obj->query($sql);
        $data=$stm->fetchALL();
        $soluongdh=0;
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Danh sách đơn hàng hủy</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id=""  width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            if($noidung!='')
                                            {
                                                ...
                                                $sqldh="SELECT * from donhang where trangthai LIKE '%Đơn hàng đã bị hủy%' LIMIT $tung_trang,$so_dh_1trang ";
                                                $stmdh= $obj->query($sqldh);
                                            }
                                            $dh=$stmdh->fetchALL();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a  href="chucnang.php?action=khoiphuc&madonhang=<?php echo $v['madonhang']?>">
                                                        <div style="background-color:#007bff; color:white;" class="btn btn-mini">Khôi phục</div>
                                                    </a> -->
                                                    <a  href="chucnang.php?action=xoadh_huy&madonhang=<?php echo $v['madonhang']?>">
                                    ...
                                    <div style="margin-left:500px;">
                                        ...
                                        {
                                            ?>
                                            <a href="dshuydonhang.php?trang=<?php echo $i?>"><?php echo $i?></a>
                                            <?php
                                        }
                                        ?>
                                    </div>

            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Điều phối đơn hàng</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                    Danh sách đơn hàng
                                <div class="btn btn-mini" style="background-color:blue; float:right;"><a style="color:white;" href="xacnhandh.php">Tiến hành giao hàng</a></div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id=""  width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            if($noidung!='')
                                            {
                                                ...
                                                $sqldh="SELECT * from donhang where trangthai='chờ xác nhận' LIMIT $tung_trang,$so_dh_1trang ";
                                                $stmdh= $obj->query($sqldh);
                                            }
                                            $dh=$stmdh->fetchALL();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="chucnang.php?action=xacnhan&madonhang=<?php echo $v['madonhang']?>">
                                                        <div style="background-color:#007bff; color:white;" class="btn btn-mini">Xác Nhận</div>
                                                    </a>
                                                    <a  href="noidunghuydh.php?madonhang=<?php echo $v['madonhang']?>">
                                                        <div style="color:white;background-color:#dc3545;"class="btn btn-mini">Hủy</div>
                                                    </a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <div style="margin-left:500px;">
                                        ...
                                        {
                                            ?>
                                            <a href="quanlydonhang.php?trang=<?php echo $i?>"><?php echo $i?></a>
                                            <?php
                                        }
                                        ?>
                                    </div>

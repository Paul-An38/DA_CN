...
<html lang="en">
    ...
    <?php
        ...
        $ma= isset($_GET['madonhang'])?$_GET['madonhang']:'';
        $sql="SELECT * From chitiet_dh
        where  chitiet_dh.madonhang='{$ma}'";
        $stm=$obj->query($sql);
        $data=$stm->fetchALL();
        $soluongdh=0;
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Navbar tim kiem-->
            <form action="chitiet_DH.php" method="post" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active"><?php echo "Số lượng sản phẩm Đơn Hàng: $soluongdh"?></li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                    Danh sách đơn hàng
                                    <!--  <div class="btn btn-mini" style="background-color:brown; float:right;"><a style="color:white;" href="<?php header('location:');?>">Trở lại</a></div>
                             --> <button class="btn btn-mini" style="background-color:brown; color:white; float:right;" type="button" onclick="quaylai()" >Quay lại</button>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id=""  width="100%" cellspacing="0">
                                        ...
                                        <?php
                                            ...
                                            if($noidung!='')
                                            {
                                                $sqldh="SELECT * from donhang join chitiet_dh on donhang.madonhang=chitiet_dh.madonhang  
                                                where donhang.madonhang like '%$noidung%'  ";
                                                ...
                                                $sqldh="SELECT * from donhang join chitiet_dh on donhang.madonhang=chitiet_dh.madonhang 
                                                 where donhang.madonhang like '%$noidung%'  LIMIT $tung_trang,$so_dh_1trang ";// phan trang cho ket qua tim kiem
                                                $stmdh= $obj->query($sqldh);    
                                            }
                                            else{
                                                $so_dh_1trang=5;
                                                ...
                                                $sqldh="SELECT * from  chitiet_dh join donhang on chitiet_dh.madonhang=donhang.madonhang
                                                where  chitiet_dh.madonhang='{$ma}' LIMIT $tung_trang,$so_dh_1trang ";
                                                $stmdh= $obj->query($sqldh);
                                            }
                                            $dh=$stmdh->fetchALL();
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($v['dongia']).".VND"?></td>
                                    ...
                                    <div style="margin-left:500px;">
                                        ...
                                        {
                                            ?>
                                            <a href="chitiet_DH.php?trang=<?php echo $i?>&madonhang=<?php echo $ma?>"><?php echo $i?></a>
                                            <?php
                                        }
                                        ?>
                                    </div>
        ...
        <script src="javascript://history.go(-1)" crossorigin="anonymous"></script>

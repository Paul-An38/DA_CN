...
<section  class="news-box top-margin">
	<div class="container"  style="background-color: white; margin-top: -15px;" >
		<div class="col-md-6" style="margin-top: 10px" > 
			...
			<ul >
				<img style="width: 400px;height: 400px" src="assets/images/<?php foreach ($data as $key => $value) {echo $value['hinh'];} ?>">
			</ul>
			<ul>
				<?php
				foreach ($data as $key => $value) {
					...
					<img style="width: 50px;height: 50px" src="assets/images/<?php foreach ($data as $key => $value) {echo $value['hinh'];} ?>">
